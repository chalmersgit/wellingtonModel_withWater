...
void banTheRewindApp::prepareSettings(Settings *settings)
{   
...
void banTheRewindApp::keyDown(KeyEvent event)
{
...
void banTheRewindApp::drawFullScreenRect()
{
    //Begin drawing
...
CINDER_APP_BASIC( banTheRewindApp, RendererGl(RendererGl::AA_MSAA_32) )
