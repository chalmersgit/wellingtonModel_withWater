...
#define RES_MODEL_VERT			CINDER_RESOURCE( ../resources/, wellingtonModelShader.vs,	132, GLSL	)
#define RES_MODEL_FRAG          CINDER_RESOURCE( ../resources/, wellingtonModelShader.fs,   133, GLSL	)
